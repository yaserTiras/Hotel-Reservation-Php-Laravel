        ...
        <div class="wrapper">
            ...
            <div class="kwicks-wrapper marg_bot1">
                <ul class="kwicks horizontal">
                    <li><img src="{{ asset('assets')}}/images/img1.jpg" alt=""></li>
            ...
            <div class="line1">
                <div class="wrapper line2">
                    ...
                    <div class="col1 pad_left1">
                        <h2><img src="{{ asset('assets')}}/images/title_marker2.jpg" alt="">Hotel Guide</h2>
                        ...
                        <a href="#" class="color1">Read More</a> </div>
                    <div class="col1 pad_left1">
                        <h2><img src="{{ asset('assets')}}/images/title_marker3.jpg" alt="">Packages</h2>
    ...
    <div class="pad">
        <div class="wrapper line3">
            ...
            <div class="col1 pad_left1">
                <h2>About Us</h2>
                <div class="wrapper">
                    <figure class="left marg_right1"><img src="{{ asset('assets')}}/images/page1_img1.jpg" alt=""></figure>
